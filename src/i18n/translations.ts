...
export const RU: Record<string, string> = {
  ...
  'Crypto currency': 'Валюта криптовалюты',
  'Fiat currency crypto holdings and totals are converted to': 'Валюта, в которую конвертируются крипто-активы и итоги',
  'Assets currencies': 'Валюты активов',
  'Currencies shown for asset totals': 'Показываются в итогах активов',
  'No assets tracked yet — add one to choose currencies here': 'Активов пока нет — добавьте один, чтобы выбрать валюты здесь',
